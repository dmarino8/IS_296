...
insert into app_role (id, role_name, description) values (2, 'ADMIN USER','Admin user');

insert into app_user (id, first_name, last_name, password, username) values (1, 'jayson', 'vincent', '1122334455abcd22dd22', 'jayson.vincent');

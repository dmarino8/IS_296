package marino.tacos.controllers;

import marino.tacos.models.CustomerReview;
import marino.tacos.repositories.CustomerReviewRepository;
...
public class CustomerReviewController {
    ...
    public ResponseEntity<CustomerReview> createReview(@RequestBody CustomerReview review) {
        try {
            CustomerReview _review = customerReviewRepository.save(new CustomerReview(review.getStars(), review.getReviewComments(), review.getProductDescription(), review.getContactPhone(), review.getContactEmail(), false));
    ...
    public ResponseEntity<CustomerReview> deleteById(@PathVariable("id") String id) {
        try {
